...
**AU6 on Windows is not green and this document does not claim it is.** No AU6 fixture is among the seven, but no AU6 fixture has a Windows measurement either: the job still fails before the run can be called green, so §13 item 5 and Appendix A row W stay empty and every AU6 Windows figure stays unmeasured.
