# Kinewright Auto-Edit Benchmark v1

This benchmark measures whether an installed agent harness can inspect generated footage, apply exact Kinewright operations, satisfy structural and semantic edit assertions, and restore the original timeline through undo.
...
cargo run -p kinewright-agent --bin kinewright-eval -- --harness claude-code
```
