...
use kinewright_core::{
    FrameTexture, MediaError, Title, title_color, title_font_bytes, title_layout,
};
...
mod tests {
    use super::*;
    use kinewright_core::CaptionPreset;
    ...
    fn vertical_social_caption_pixels_stay_inside_shared_safe_bounds() {
        ...
        let mut rendered = kinewright_core::TitlePixelBounds {
            left: i32::MAX,
            top: i32::MAX,
            right: i32::MIN,
            bottom: i32::MIN,
