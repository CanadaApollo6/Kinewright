...
use kinewright_core::{
    ...
    au6_scenarios::{
        ...
        AU6_A_VOICE_B_LEVEL_DBFS_HUNDREDTHS, AU6_A_VOICE_B_TRACK, AU6_AGENT_LANE_BUDGET_SECONDS,
        AU6_AUTHORED_LEVEL_TOLERANCE_HUNDREDTHS, AU6_B_VOICE_A_LEVEL_DBFS_HUNDREDTHS,
        AU6_B_VOICE_A_TRACK, AU6_B_VOICE_B_BUS, AU6_B_VOICE_B_LEVEL_DBFS_HUNDREDTHS,
        AU6_B_VOICE_B_TRACK, AU6_BUDGETS, AU6_C_CLICK_COUNT, AU6_C_CLICK_FRAMES,
        AU6_C_DETECTED_SILENCES, AU6_C_DIALOGUE_TRACK, AU6_C_GAP_RANGE, AU6_C_GAPS,
        AU6_C_HUM_FUNDAMENTAL_HERTZ, AU6_C_HUM_LEVEL_DBFS_HUNDREDTHS, AU6_C_HUM_PARTIALS,
        AU6_C_LEAKAGE_WORST_BAND, AU6_C_LEARN_PROJECT_RANGE, AU6_C_LEARN_SOURCE_RANGE,
        AU6_C_LEARNED_PROFILE_TENTH_DB, AU6_C_MIDDLE_CLIP_ID, AU6_C_NOISE_LEVEL_DBFS_HUNDREDTHS,
        ...
        AU6_C_RIGHT_CLIP_ID, AU6_C_ROOM_TONE_ASSET_FRAMES, AU6_C_ROOM_TONE_FPS,
        AU6_C_VOICE_CARRIER, AU6_C_VOICE_LEVEL_DBFS_HUNDREDTHS, AU6_CHANNELS, AU6_CLICK_SAMPLES,
        AU6_D_ANGLE_OFFSETS_FRAMES, AU6_D_CUT_FRAMES, AU6_D_DELETED_CLIP_IDS, AU6_D_MASTER_CLIP_ID,
...
const AU6_MANIFEST_PLACEHOLDER_NEEDLES: [&str; 6] =
    ["[probe]", "[probe-2]", "[probe-3]", "TODO", "TBD", "FIXME"];
...
fn au6_manifest_declares_every_required_fixture_and_constant() {
    ...
    assert_eq!(
        self_test["top_level_keys"].as_u64(),
