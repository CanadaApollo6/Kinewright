...
use kinewright_core::{
    ...
    au6_scenarios::{
        ...
        au6_turns_of, Au6Scenario, Au6Speaker, Au6TrackRole, AU6_AGENT_LANE_BUDGET_SECONDS,
        AU6_AUTHORED_LEVEL_TOLERANCE_HUNDREDTHS, AU6_A_BED_LEVEL_DBFS_HUNDREDTHS, AU6_A_BED_TRACK,
        AU6_A_CLIPS, AU6_A_DIALOGUE_BUS_NAME, AU6_A_MUSIC_BUS, AU6_A_MUSIC_BUS_NAME,
        AU6_A_VOICE_A_LEVEL_DBFS_HUNDREDTHS, AU6_A_VOICE_A_TRACK,
        AU6_A_VOICE_B_LEVEL_DBFS_HUNDREDTHS, AU6_A_VOICE_B_TRACK,
        AU6_B_VOICE_A_LEVEL_DBFS_HUNDREDTHS, AU6_B_VOICE_A_TRACK, AU6_B_VOICE_B_BUS,
        AU6_B_VOICE_B_LEVEL_DBFS_HUNDREDTHS, AU6_B_VOICE_B_TRACK, AU6_CHANNELS, AU6_CLICK_SAMPLES,
        AU6_C_CLICK_COUNT, AU6_C_CLICK_FRAMES, AU6_C_DETECTED_SILENCES, AU6_C_DIALOGUE_TRACK,
        AU6_C_GAPS, AU6_C_GAP_RANGE, AU6_C_HUM_FUNDAMENTAL_HERTZ, AU6_C_HUM_LEVEL_DBFS_HUNDREDTHS,
        AU6_C_HUM_PARTIALS, AU6_C_LEAKAGE_WORST_BAND, AU6_C_LEARNED_PROFILE_TENTH_DB,
        AU6_C_LEARN_PROJECT_RANGE, AU6_C_LEARN_SOURCE_RANGE, AU6_C_NOISE_LEVEL_DBFS_HUNDREDTHS,
        AU6_C_ONE_FRAME_OFFSET_BAND0_TENTH_DB, AU6_C_ONE_FRAME_OFFSET_MAX_DELTA_TENTH_DB,
        AU6_C_PROFILE_HUM_BUMP_BANDS, AU6_C_PROFILE_LOW_FALLOFF_BANDS,
        AU6_C_PROFILE_MONOTONE_FROM_BAND, AU6_C_PROGRAMME_FRAMES, AU6_C_REPAIR_BUS,
        AU6_C_ROOM_TONE_ASSET_FRAMES, AU6_C_ROOM_TONE_FPS, AU6_C_VOICE_CARRIER,
        AU6_C_VOICE_LEVEL_DBFS_HUNDREDTHS, AU6_DECLICK_ERROR_DROP_MIN_TENTH_DB,
        AU6_DELIVERY_DEVIATION_MAX_LU_HUNDREDTHS, AU6_DELIVERY_TRUE_PEAK_MARGIN_MIN_HUNDREDTHS,
        AU6_DUCK_DEPTH_MIN_HUNDREDTHS, AU6_D_ANGLE_OFFSETS_FRAMES, AU6_D_CUT_FRAMES,
        AU6_D_MASTER_CLIP_ID, AU6_D_MASTER_LEVEL_DBFS_HUNDREDTHS, AU6_D_MASTER_TRACK,
        AU6_D_SCRATCH_1_TRACK, AU6_D_SCRATCH_2_TRACK, AU6_D_SCRATCH_NOISE_LEVEL_DBFS_HUNDREDTHS,
        AU6_D_VISIBLE_ANGLE_PER_SEGMENT, AU6_ENCODE_PROGRAMME_FRAMES, AU6_EXPORT_JOBS,
        ...
        AU6_REPAIR_SPEECH_LOSS_MAX_DB_HUNDREDTHS, AU6_SAMPLES_PER_FRAME, AU6_SAMPLE_RATE,
        ...
        AU6_VOICE_BAND_SEPARATION_BANDS, AU6_VOICE_B_BAND_INDEX, AU6_VOICE_MATCH_MAX_LU_HUNDREDTHS,
        AU6_WINDOW_MILLISECONDS, AU6_WINDOW_PROGRAMME,
    },
    ...
    MixSpectrumPoint, MixSpectrumRequest, MixWindowLevelReport, MixWindowRequest, Operation,
    ParamValue, Rational, SilenceStatus, TimeCode, Track, TrackId, TrackKind,
    NOISE_PROFILE_BAND_COUNT, NOISE_PROFILE_PARAMETER_NAMES, PROFILE_BAND_NEUTRAL_TENTH_DB,
};

use crate::{
    au6_sources::{
        au6_analytic_level_dbfs_hundredths, au6_angle_source, au6_c_click_free_track,
        au6_c_voice_only_track, au6_chord_bed_pcm, au6_clicks_into, au6_hum_pcm, au6_muxed_source,
        au6_noise_pcm, au6_picture_source, au6_ride_pcm, au6_scenario_sources, au6_scenario_tracks,
        au6_scratch_pcm, au6_source, au6_stamp_on_project_grid, au6_steady_voice_pcm,
        au6_to_stereo, au6_voice_pcm, AU6_MUX_RECIPE, AU6_VIDEO_ONLY_RECIPE,
    },
    ...
    export::{mix_audio_stems, MixStems},
    initialize_ffmpeg,
    ...
    test_support::{wav_f32, GeneratedMedia, TempDirectory},
    FfmpegMediaEngine,
};
...
fn au6_c_the_declick_node_alone_drops_the_click_error() {
    ...
    println!(
        ...
        rms(&degraded.iter().zip(&click_free).map(|(a, b)| a - b).collect::<Vec<_>>()),
        rms(&after.iter().zip(&click_free).map(|(a, b)| a - b).collect::<Vec<_>>()),
