...
fn main() {
    ...
    println!("cargo:rerun-if-changed=assets/kinewright.ico");
    ...
    let icon_path = out_dir.join("Kinewright.ico");
    let resource_script = out_dir.join("Kinewright.rc");
    ...
    write_resource_script(&resource_script, &icon_path, &version)
        .expect("failed to generate the Kinewright Windows resource script");
    ...
    println!(
        "cargo:rustc-link-arg-bin=kinewright-app={}",
...
BEGIN
    ...
    BEGIN
        BLOCK "040904b0"
        BEGIN
            VALUE "CompanyName", "Kinewright contributors\0"
            VALUE "FileDescription", "Kinewright video editor\0"
            VALUE "FileVersion", "{version}\0"
            VALUE "InternalName", "Kinewright\0"
            VALUE "LegalCopyright", "Copyright Kinewright contributors\0"
            VALUE "LegalTrademarks", "Licensed under GPL-3.0-only\0"
            VALUE "OriginalFilename", "Kinewright.exe\0"
            VALUE "ProductName", "Kinewright\0"
