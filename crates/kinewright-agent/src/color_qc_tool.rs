...
use kinewright_core::{
    ...
    delivery_color_for_depth, matte_coverage_statistics, measure_color_qc, nodes,
...
fn assumptions(checks: &[ColorQcCheck], depth: DeliveryEncodeDepth, per_node: bool) -> Vec<String> {
    ...
    if checks.contains(&ColorQcCheck::Skin) {
