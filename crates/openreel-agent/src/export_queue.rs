...
impl ExportQueue {
    ...
    pub fn with_capacity(
        ...
        thread::Builder::new()
            .name("openreel-export-queue".to_owned())
...
fn run_work_item(state: &Arc<QueueState>, work: WorkItem) {
    ...
    let progress_thread = thread::Builder::new()
        .name(format!("openreel-export-progress-{}", work.id.0))
...
mod tests {
    ...
    impl Export for RecordingExporter {
        fn export(
            &self,
            _out: &Path,
            _settings: openreel_core::ExportSettings,
            _progress: openreel_core::ProgressSink,
        ) -> Result<(), MediaError> {
        ...
        fn export_document(
            ...
            out: &Path,
            _settings: openreel_core::ExportSettings,
            progress: openreel_core::ProgressSink,
        ) -> Result<(), MediaError> {
    ...
    impl Export for CancellableExporter {
        ...
        fn export_document(
            ...
            _document: Arc<Document>,
            _out: &Path,
            settings: openreel_core::ExportSettings,
            _progress: openreel_core::ProgressSink,
        ) -> Result<(), MediaError> {
            let _ = self.started_tx.send(());
