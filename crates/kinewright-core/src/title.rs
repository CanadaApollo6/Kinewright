...
const INTER_BYTES: &[u8] = include_bytes!("../../kinewright-app/assets/fonts/Inter-Variable.ttf");
...
/// Embedded title font bytes used by every `Kinewright` title renderer.
#[must_use]
...
///
/// Caption layouts reserve enough room for `Kinewright`'s largest built-in pop and
