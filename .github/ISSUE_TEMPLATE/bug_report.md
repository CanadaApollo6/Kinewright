...
**Error log**
If the in-app error panel (top-right chip) has entries, paste them here.

**Project file / media**
If you can share a minimal `.kinewright` project or clip that reproduces it, link it here.
